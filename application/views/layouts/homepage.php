...
<html lang="en">
    ...
    <head>
        ...
        <title>Inovation Products</title>

        <!-- Bootstrap Core CSS -->
        <link href="<?php echo base_url(); ?>assets/front/style/bootstrap.css" rel="stylesheet">
        <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600' rel='stylesheet' type='text/css'>
        <link href="<?php echo base_url(); ?>assets/front/style/prettyPhoto.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>assets/front/style/flexslider.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>assets/front/style/font-awesome.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>assets/front/style/style.css" rel="stylesheet">
        <link href="<?php echo base_url(); ?>assets/front/style/red.css" rel="stylesheet">
              ...
              <div class="col-md-4">
                <div class="widget">
                  ...
                  <div class="payment-icons">
                    <img src="assets/front/img/payment/americanexpress.gif" alt="" />
                    <img src="assets/front/img/payment/visa.gif" alt="" />
                    <img src="assets/front/img/payment/mastercard.gif" alt="" />
                    <img src="assets/front/img/payment/discover.gif" alt="" />
                    <img src="assets/front/img/payment/paypal.gif" alt="" />
                  </div>
                </div>
              </div>
...
<!-- JS -->
<script src="<?php echo base_url(); ?>assets/front/js/jquery.js"></script> <!-- jQuery -->
<script src="<?php echo base_url(); ?>assets/front/js/bootstrap.js"></script> <!-- Bootstrap -->
<script src="<?php echo base_url(); ?>assets/front/js/jquery.prettyPhoto.js"></script> <!-- Pretty Photo -->
<script src="<?php echo base_url(); ?>assets/front/js/filter.js"></script> <!-- Filter for support page -->

<script src="<?php echo base_url(); ?>assets/front/js/jquery.flexslider-min.js"></script> <!-- Flex slider -->

<script src="<?php echo base_url(); ?>assets/front/js/jquery.carouFredSel-6.1.0-packed.js"></script> <!-- Carousel for recent posts -->
<script src="<?php echo base_url(); ?>assets/front/js/custom.js"></script> <!-- Custom codes -->
</body>
</html>